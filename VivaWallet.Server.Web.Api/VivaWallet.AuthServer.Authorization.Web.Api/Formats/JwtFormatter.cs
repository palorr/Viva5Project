...
namespace VivaWallet.AuthServer.Authorization.Web.Api.Formats

{
    ...
    //        var token = new JwtSecurityToken(_issuer, audience.ClientId, data.Identity.Claims, issued.Value.UtcDateTime, expires.Value.UtcDateTime, signingCredentials);
